    ...
    try
    {
      ...
      {                                         //  with customer
        ...
        {                                       // T
          ...
          Product updatedProduct = theStock.getDetails(theProduct.getProductNum());
          int updatedStock = updatedProduct.getQuantity();

            theAction = String.format("Remaining stock: %d",
                    updatedStock
            );
